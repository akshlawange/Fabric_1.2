...
func (t *utilityHandler) readMultiSettlementInstructions(stub shim.ChaincodeStubInterface, collection string, objectType string, attributes []string) ([]byte, error) {
