...
// =========================================================================================
func (t *utilityHandler) getQueryResultForQueryString(stub shim.ChaincodeStubInterface, collection string, queryString string) ([]byte, error) {
...
func (t *utilityHandler) readSingleJSON(stub shim.ChaincodeStubInterface, collection string, objectType string, attributes []string) ([]byte, error) {

	fmt.Println("###### MultiPartyChaincode: function: readSingleJSON ")
	Key := []string{}
	...
	fmt.Println("Retrived JSON ::", string(compositeKey), string(JSONBytes))

	return JSONBytes, nil
}

func (t *utilityHandler) readMultiJSON(stub shim.ChaincodeStubInterface, collection string, objectType string, attributes []string) ([]byte, error) {

	fmt.Println("###### MultiPartyChaincode: function: readMultiJSON ")
	var finaldata []byte
	partialKey := []string{}
